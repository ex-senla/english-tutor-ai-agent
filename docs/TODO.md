...
| 6 | **Добавление слов на уроке** | ✅ done | `/addword` → слово → POS → переводы | 3 шага: AWAITING_WORD → AWAITING_POS → AWAITING_TRANSLATION |
| 7 | **Завершение урока** | ✅ done | `/finishlesson` | EndLesson, возврат в STUDENT_OPTIONS |
