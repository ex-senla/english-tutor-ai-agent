...
public enum State {
    ...
    ACTIVE(START, NEW_STUDENT, START_LESSON, EXERCISE, STUDENTS, STUDENT, HELP),
    IN_LESSON(ADD_WORD, END_LESSON, EXERCISE, STUDENTS, STUDENT, HELP);
    ...
    public String[] keyboardButtons() {
        return switch (this) {
            ...
            case ACTIVE -> new String[]{"/newstudent", "/startlesson", "/students", "/exercise", "/help"};
